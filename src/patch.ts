import { Browser, Page } from "npm:puppeteer-core@22.9.0";
import { importFSPromises } from "npm:puppeteer-core@22.9.0/internal/common/util.js";
...
declare module "npm:puppeteer-core@22.9.0" {
  interface Browser {
